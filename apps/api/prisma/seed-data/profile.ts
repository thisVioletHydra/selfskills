export const profileSeed = {
  ...
  about: [
    ...
    'Свободно собираю продукт целиком: frontend, GraphQL API и база данных как единая система с общими типами на TypeScript. В своих проектах довожу до продакшена связку React + NestJS + Prisma с деплоем на Railway, Neon и GitHub Pages. В платёжной логике реализовал webhook с идемпотентностью, конкурентно-безопасную выдачу ключей и retry-логику для внешних поставщиков. Уверенно работаю с Docker и виртуализацией: подбираю базовые образы (Alpine вместо полного Node-образа), пишу docker-compose для локальной разработки и настраиваю пайплайны в GitHub Actions.',
