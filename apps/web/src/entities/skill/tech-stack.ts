...
export const TECH_STACK: TechStackItem[] = [
  ...
  },
  {
    ...
    experience: "Годы в проде: Browserslist, legacy/modern-сборки, точечные фиксы под старые браузеры.",
    icon: postcssIcon,
    size: 42,
  },
  {
  ...
  },
  {
    ...
    experience: "Для внутренних пакетов и либ — быстрее и проще классического tsc+бандлер-зоопарка.",
    icon: tsdownIcon,
    size: 42,
  },
  {
